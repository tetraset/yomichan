// You need to add this line in new builded templates.js
...
templates['terms.html'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return buffer + "</span></li>\n";
    ...
    return container.lambda(depth0, depth0);
  ...
  return container.lambda(((stack1 = (depth0 != null ? depth0.glossary : depth0)) != null ? stack1["0"] : stack1), depth0);
...
module.exports.templates = templates || Handlebars.templates || {};